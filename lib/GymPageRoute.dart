...
class _RaynesParkPageTransition extends StatelessWidget {
  _RaynesParkPageTransition({
    Key key,
    @required bool fade,
...
class GymPageRoute<T> extends PageRoute<T> {
  ...
  bool canTransitionFrom(TransitionRoute<dynamic> previousRoute) {
    return previousRoute is GymPageRoute || previousRoute is CupertinoPageRoute;
  }
